...
# Desactivar cualquier SWAP activo en sde1 para evitar conflictos
sudo swapoff /dev/sde1 || echo "No se pudo desactivar SWAP en /dev/sde1"
...
# Reactivar SWAP solo en vg_temp-lv_swap
...
# Mostrar el estado actual de los volúmenes lógicos
lsblk